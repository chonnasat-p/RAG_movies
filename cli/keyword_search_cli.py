...
def main() -> None:
    ...
    build_parser = subparsers.add_parser("build", help="Build InvertedIndex class")

    tf_parser = subparsers.add_parser("tf", help="Get term frequency for a given document ID and term")
    tf_parser.add_argument("doc_id", type=int, help="Document ID query")
    ...
    tfidf_parser.add_argument("doc_id", type=int, help="Document ID query")
